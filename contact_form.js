...
function trullify_Contact_Form() {
    // Form Fields
    ...
    // Contact Form
    if ( jQuery('.trullify-contact-form:not(.is-init)').length ) {
        jQuery('.trullify-contact-form:not(.is-init)').each(function() {
            let $form = jQuery(this),
                $response = $form.find('.trullify-contact-form__response'),
                formData;
            ...
            $form.on('submit', function(e) {
                ...
                .done(function(response) {
                    ...
                    $response.empty().removeClass('trullify-alert-danger').addClass('trullify-alert-success').slideDown(200);
                ...
                .fail(function(data) {
                    $form.removeClass('is-busy');
                    $response.empty().removeClass('trullify-alert-success').addClass('trullify-alert-danger').slideDown(200);
